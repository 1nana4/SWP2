...
#define _DUTY_MAX 2270 // 2500
#define _DUTY_NEU 1700 // 1800
#define _DUTY_MIN 930 // 1000

#define _SERVO_ANGLE_DIFF  70  // Replace with |D - E| degree
#define _SERVO_SPEED 100        // servo speed

#define _BANGBANG_RANGE    220  // duty up and down for bangbang control
...
float volt_to_distance(int a_value)
{
  ...
  return 508 + (-1.85 * a_value) + (1.74e-3 * a_value * a_value);
}
